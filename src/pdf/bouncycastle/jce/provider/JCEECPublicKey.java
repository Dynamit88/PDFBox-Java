...
import pdf.bouncycastle.math.ec.custom.sec.SecP256K1Point;
import pdf.bouncycastle.math.ec.custom.sec.SecP256R1Point;
    ...
    implements ECPublicKey, pdf.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private pdf.bouncycastle.math.ec.ECPoint q;
        ...
        pdf.bouncycastle.jce.spec.ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                pdf.bouncycastle.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public pdf.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
