...
import pdf.bouncycastle.jcajce.provider.symmetric.util.ClassUtil;
...
import pdf.bouncycastle.pqc.jcajce.provider.mceliece.McElieceCCA2KeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.newhope.NHKeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.qtesla.QTESLAKeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.rainbow.RainbowKeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.sphincs.Sphincs256KeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.xmss.XMSSKeyFactorySpi;
import pdf.bouncycastle.pqc.jcajce.provider.xmss.XMSSMTKeyFactorySpi;
 ...
 * <pre>
 * <code>
 *    security.provider.&lt;n&gt;=pdf.bouncycastle.jce.provider.BouncyCastleProvider
 * </code>
 * </pre>
    ...
    implements ConfigurableProvider
{
     ...
     */
    private static final String SYMMETRIC_PACKAGE = "pdf.bouncycastle.jcajce.provider.symmetric.";
     ...
     */
    private static final String ASYMMETRIC_PACKAGE = "pdf.bouncycastle.jcajce.provider.asymmetric.";
     ...
     */
    private static final String DIGEST_PACKAGE = "pdf.bouncycastle.jcajce.provider.digest.";
     ...
     */
    private static final String KEYSTORE_PACKAGE = "pdf.bouncycastle.jcajce.provider.keystore.";
     ...
     */
    private static final String SECURE_RANDOM_PACKAGE = "pdf.bouncycastle.jcajce.provider.drbg.";
    ...
    private void setup()
    {
        ...
        // X509Store
        //
        put("X509Store.CERTIFICATE/COLLECTION", "pdf.bouncycastle.jce.provider.X509StoreCertCollection");
        put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "pdf.bouncycastle.jce.provider.X509StoreAttrCertCollection");
        put("X509Store.CRL/COLLECTION", "pdf.bouncycastle.jce.provider.X509StoreCRLCollection");
        put("X509Store.CERTIFICATEPAIR/COLLECTION", "pdf.bouncycastle.jce.provider.X509StoreCertPairCollection");

        put("X509Store.CERTIFICATE/LDAP", "pdf.bouncycastle.jce.provider.X509StoreLDAPCerts");
        put("X509Store.CRL/LDAP", "pdf.bouncycastle.jce.provider.X509StoreLDAPCRLs");
        put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "pdf.bouncycastle.jce.provider.X509StoreLDAPAttrCerts");
        put("X509Store.CERTIFICATEPAIR/LDAP", "pdf.bouncycastle.jce.provider.X509StoreLDAPCertPairs");
        
        //
        // X509StreamParser
        //
        put("X509StreamParser.CERTIFICATE", "pdf.bouncycastle.jce.provider.X509CertParser");
        put("X509StreamParser.ATTRIBUTECERTIFICATE", "pdf.bouncycastle.jce.provider.X509AttrCertParser");
        put("X509StreamParser.CRL", "pdf.bouncycastle.jce.provider.X509CRLParser");
        put("X509StreamParser.CERTIFICATEPAIR", "pdf.bouncycastle.jce.provider.X509CertPairParser");

        //
        // cipher engines
        //
        put("Cipher.BROKENPBEWITHMD5ANDDES", "pdf.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");

        put("Cipher.BROKENPBEWITHSHA1ANDDES", "pdf.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");


        put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "pdf.bouncycastle.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");

        // Certification Path API
        put("CertPathValidator.RFC3281", "pdf.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi");
        put("CertPathBuilder.RFC3281", "pdf.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi");
        put("CertPathValidator.RFC3280", "pdf.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
        put("CertPathBuilder.RFC3280", "pdf.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
        put("CertPathValidator.PKIX", "pdf.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
        put("CertPathBuilder.PKIX", "pdf.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
        put("CertStore.Collection", "pdf.bouncycastle.jce.provider.CertStoreCollectionSpi");
        put("CertStore.LDAP", "pdf.bouncycastle.jce.provider.X509LDAPCertStoreSpi");
        put("CertStore.Multi", "pdf.bouncycastle.jce.provider.MultiCertStoreSpi");
