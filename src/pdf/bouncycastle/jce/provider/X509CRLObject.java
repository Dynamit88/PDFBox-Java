...
import pdf.bouncycastle.asn1.x509.CRLNumber;
...
import pdf.bouncycastle.asn1.x509.TBSCertList;
            ...
            while (certs.hasMoreElements())
            {
                ...
                if (entry.getUserCertificate().getValue().equals(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = pdf.bouncycastle.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
