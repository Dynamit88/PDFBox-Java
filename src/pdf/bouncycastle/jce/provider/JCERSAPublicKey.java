    ...
    implements RSAPublicKey
{
        ...
        SubjectPublicKeyInfo    info)
    {
        try
        {
            pdf.bouncycastle.asn1.pkcs.RSAPublicKey   pubKey = pdf.bouncycastle.asn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.rsaEncryption, DERNull.INSTANCE), new pdf.bouncycastle.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
