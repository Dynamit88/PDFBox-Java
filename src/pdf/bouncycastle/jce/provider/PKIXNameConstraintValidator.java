...
import pdf.bouncycastle.asn1.x509.NameConstraintValidatorException;

public class PKIXNameConstraintValidator
{
    pdf.bouncycastle.asn1.x509.PKIXNameConstraintValidator validator = new pdf.bouncycastle.asn1.x509.PKIXNameConstraintValidator();
