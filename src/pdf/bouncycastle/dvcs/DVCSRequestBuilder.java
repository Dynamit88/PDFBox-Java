...
import pdf.bouncycastle.asn1.dvcs.DVCSRequestInformationBuilder;
import pdf.bouncycastle.asn1.dvcs.Data;
...
public abstract class DVCSRequestBuilder
{
        ...
        throws DVCSException
    {
        ...
        pdf.bouncycastle.asn1.dvcs.DVCSRequest request = new pdf.bouncycastle.asn1.dvcs.DVCSRequest(requestInformationBuilder.build(), data);
