...
import pdf.bouncycastle.asn1.dvcs.ServiceType;
...
public class DVCSRequest
    extends DVCSMessage
{
    private pdf.bouncycastle.asn1.dvcs.DVCSRequest asn1;
        ...
        throws DVCSConstructionException
    {
        ...
        try
        {
            ...
            {
                this.asn1 = pdf.bouncycastle.asn1.dvcs.DVCSRequest.getInstance(contentInfo.getContent());
            }
            else
            {
                this.asn1 = pdf.bouncycastle.asn1.dvcs.DVCSRequest.getInstance(ASN1OctetString.getInstance(contentInfo.getContent()).getOctets());
            }
        }
        catch (Exception e)
        {
     ...
     *
     * @return an pdf.bouncycastle.asn1.dvcs.DVCSRequest object.
     */
