package pdf.bouncycastle.est.jcajce;
...
import pdf.bouncycastle.est.ESTClient;
import pdf.bouncycastle.est.ESTClientSourceProvider;
import pdf.bouncycastle.est.ESTException;
import pdf.bouncycastle.est.ESTRequest;
import pdf.bouncycastle.est.ESTRequestBuilder;
import pdf.bouncycastle.est.ESTResponse;
import pdf.bouncycastle.est.Source;
    ...
    implements ESTClient
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            Set<String> opts = Properties.asKeySet("pdf.bouncycastle.debug.est");
