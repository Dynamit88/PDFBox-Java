...
import pdf.bouncycastle.asn1.cms.CMSAlgorithmProtection;
import pdf.bouncycastle.asn1.cms.CMSAttributes;
import pdf.bouncycastle.asn1.cms.IssuerAndSerialNumber;
import pdf.bouncycastle.asn1.cms.SignerIdentifier;
import pdf.bouncycastle.asn1.cms.SignerInfo;
import pdf.bouncycastle.asn1.cms.Time;
...
import pdf.bouncycastle.operator.RawContentVerifier;
...
public class SignerInformation
{
     ...
     * @throws pdf.bouncycastle.cms.CMSVerifierCertificateNotValidException if the provider has an associated certificate and the certificate is not valid at the time given as the SignerInfo's signing time.
     * @throws pdf.bouncycastle.cms.CMSException if the verifier is unable to create a ContentVerifiers or DigestCalculators.
     */
