...
import pdf.bouncycastle.util.Shorts;
...
public class TlsUtils
{
    ...
    static void validateKeyUsage(pdf.bouncycastle.asn1.x509.Certificate c, int keyUsageBits)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        pdf.bouncycastle.asn1.x509.Certificate x509Cert = clientCertificate.getCertificateAt(0);
