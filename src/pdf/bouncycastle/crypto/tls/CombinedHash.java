    ...
    implements TlsHandshakeHash
{
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#update(byte[], int, int)
     */
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#doFinal(byte[], int)
     */
    ...
    /**
     * @see pdf.bouncycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
