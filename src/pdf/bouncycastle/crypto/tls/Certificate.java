 ...
 * </pre>
 *
 * @see pdf.bouncycastle.asn1.x509.Certificate
 */
public class Certificate
{
    public static final Certificate EMPTY_CHAIN = new Certificate(
        new pdf.bouncycastle.asn1.x509.Certificate[0]);

    protected pdf.bouncycastle.asn1.x509.Certificate[] certificateList;

    public Certificate(pdf.bouncycastle.asn1.x509.Certificate[] certificateList)
    {
    ...
    /**
     * @return an array of {@link pdf.bouncycastle.asn1.x509.Certificate} representing a certificate
     *         chain.
     */
    public pdf.bouncycastle.asn1.x509.Certificate[] getCertificateList()
    {
        return cloneCertificateList();
    }

    public pdf.bouncycastle.asn1.x509.Certificate getCertificateAt(int index)
    {
        ...
        throws IOException
    {
        ...
        while (buf.available() > 0)
        {
            ...
            certificate_list.addElement(pdf.bouncycastle.asn1.x509.Certificate.getInstance(asn1Cert));
        }

        pdf.bouncycastle.asn1.x509.Certificate[] certificateList = new pdf.bouncycastle.asn1.x509.Certificate[certificate_list.size()];
        for (int i = 0; i < certificate_list.size(); i++)
        {
            certificateList[i] = (pdf.bouncycastle.asn1.x509.Certificate)certificate_list.elementAt(i);
        }
        return new Certificate(certificateList);
    }

    protected pdf.bouncycastle.asn1.x509.Certificate[] cloneCertificateList()
    {
        pdf.bouncycastle.asn1.x509.Certificate[] result = new pdf.bouncycastle.asn1.x509.Certificate[certificateList.length];
