package pdf.bouncycastle.crypto.agreement.jpake;
...
public class JPAKERound3Payload
{
     ...
     *
     * @see JPAKEUtil#calculateMacTag(String, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, pdf.bouncycastle.crypto.Digest)
     */
