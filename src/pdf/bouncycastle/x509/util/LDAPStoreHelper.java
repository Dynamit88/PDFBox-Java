package pdf.bouncycastle.x509.util;
...
import pdf.bouncycastle.asn1.x509.CertificatePair;
import pdf.bouncycastle.jce.X509LDAPCertStoreParameters;
import pdf.bouncycastle.jce.provider.X509AttrCertParser;
import pdf.bouncycastle.jce.provider.X509CRLParser;
import pdf.bouncycastle.jce.provider.X509CertPairParser;
import pdf.bouncycastle.jce.provider.X509CertParser;
import pdf.bouncycastle.util.StoreException;
import pdf.bouncycastle.x509.X509AttributeCertStoreSelector;
import pdf.bouncycastle.x509.X509AttributeCertificate;
import pdf.bouncycastle.x509.X509CRLStoreSelector;
import pdf.bouncycastle.x509.X509CertPairStoreSelector;
import pdf.bouncycastle.x509.X509CertStoreSelector;
import pdf.bouncycastle.x509.X509CertificatePair;
 ...
 * {@link pdf.bouncycastle.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link pdf.bouncycastle.x509.X509CertStoreSelector} or
 * {@link pdf.bouncycastle.x509.X509AttributeCertificate} is given with that
 * details.
 * </p><p>
...
public class LDAPStoreHelper
{
     ...
     * {@link pdf.bouncycastle.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
