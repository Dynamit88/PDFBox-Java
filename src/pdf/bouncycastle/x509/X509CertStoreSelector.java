 ...
 * 
 * @see pdf.bouncycastle.util.Selector
 * @see pdf.bouncycastle.x509.X509Store
 * @see pdf.bouncycastle.jce.provider.X509StoreCertCollection
 * @deprecated use the classes under pdf.bouncycastle.cert.selector
 */
