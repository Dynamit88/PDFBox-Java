package pdf.bouncycastle.eac.jcajce;
...
import pdf.bouncycastle.asn1.eac.EACObjectIdentifiers;
import pdf.bouncycastle.asn1.eac.ECDSAPublicKey;
import pdf.bouncycastle.asn1.eac.PublicKeyDataObject;
import pdf.bouncycastle.asn1.eac.RSAPublicKey;
import pdf.bouncycastle.eac.EACException;
...
public class JcaPublicKeyConverter
{
    ...
    private static pdf.bouncycastle.math.ec.ECPoint convertPoint(
        ECCurve curve,
