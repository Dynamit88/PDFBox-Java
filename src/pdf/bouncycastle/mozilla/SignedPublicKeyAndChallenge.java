package pdf.bouncycastle.mozilla;
...
import pdf.bouncycastle.asn1.mozilla.PublicKeyAndChallenge;
...
{
    protected final pdf.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge          spkacSeq;

    public SignedPublicKeyAndChallenge(byte[] bytes)
    {
        spkacSeq = pdf.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge.getInstance(bytes);
    }

    protected SignedPublicKeyAndChallenge(pdf.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge struct)
    {
     ...
     */
    public pdf.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge toASN1Structure()
    {
         return spkacSeq;
    }
