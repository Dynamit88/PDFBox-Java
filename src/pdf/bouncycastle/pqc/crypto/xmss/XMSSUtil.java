...
public class XMSSUtil
{
       ...
       extends ObjectInputStream
    {
        ...
        static
        {
            ...
            components.add("pdf.bouncycastle.pqc.crypto.xmss.BDS");
            components.add("java.util.ArrayList");
            components.add("pdf.bouncycastle.pqc.crypto.xmss.XMSSNode");
            components.add("[B");
            ...
            components.add("pdf.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
        }
