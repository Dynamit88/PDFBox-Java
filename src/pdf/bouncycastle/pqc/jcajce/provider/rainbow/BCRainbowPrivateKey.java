...
import pdf.bouncycastle.pqc.asn1.RainbowPrivateKey;
import pdf.bouncycastle.pqc.crypto.rainbow.Layer;
import pdf.bouncycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import pdf.bouncycastle.pqc.crypto.rainbow.util.RainbowUtil;
import pdf.bouncycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + pdf.bouncycastle.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + pdf.bouncycastle.util.Arrays.hashCode(b1);
        hash = hash * 37 + pdf.bouncycastle.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + pdf.bouncycastle.util.Arrays.hashCode(b2);
        hash = hash * 37 + pdf.bouncycastle.util.Arrays.hashCode(vi);
