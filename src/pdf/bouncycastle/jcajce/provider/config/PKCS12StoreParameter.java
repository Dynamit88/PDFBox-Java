package pdf.bouncycastle.jcajce.provider.config;
...
/**
 * @deprecated use pdf.bouncycastle.jcajce.PKCS12StoreParameter
 */
public class PKCS12StoreParameter
    extends pdf.bouncycastle.jcajce.PKCS12StoreParameter
{
