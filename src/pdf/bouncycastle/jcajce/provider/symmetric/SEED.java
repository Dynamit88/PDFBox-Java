...
import pdf.bouncycastle.crypto.engines.SEEDEngine;
import pdf.bouncycastle.crypto.engines.SEEDWrapEngine;
...
public final class SEED
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new pdf.bouncycastle.crypto.macs.Poly1305(new SEEDEngine()));
        }
    }
