...
import pdf.bouncycastle.crypto.engines.ARIAEngine;
import pdf.bouncycastle.crypto.engines.ARIAWrapEngine;
import pdf.bouncycastle.crypto.engines.ARIAWrapPadEngine;
...
public final class ARIA
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new pdf.bouncycastle.crypto.macs.Poly1305(new ARIAEngine()));
        }
    }
