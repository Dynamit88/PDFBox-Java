...
import pdf.bouncycastle.asn1.cms.GCMParameters;
...
import pdf.bouncycastle.crypto.OutputLengthException;
import pdf.bouncycastle.crypto.engines.DSTU7624Engine;
import pdf.bouncycastle.crypto.modes.AEADBlockCipher;
import pdf.bouncycastle.crypto.modes.CBCBlockCipher;
import pdf.bouncycastle.crypto.modes.CCMBlockCipher;
import pdf.bouncycastle.crypto.modes.CFBBlockCipher;
import pdf.bouncycastle.crypto.modes.CTSBlockCipher;
import pdf.bouncycastle.crypto.modes.EAXBlockCipher;
import pdf.bouncycastle.crypto.modes.GCFBBlockCipher;
import pdf.bouncycastle.crypto.modes.GCMBlockCipher;
import pdf.bouncycastle.crypto.modes.GOFBBlockCipher;
import pdf.bouncycastle.crypto.modes.KCCMBlockCipher;
import pdf.bouncycastle.crypto.modes.KCTRBlockCipher;
import pdf.bouncycastle.crypto.modes.KGCMBlockCipher;
import pdf.bouncycastle.crypto.modes.OCBBlockCipher;
import pdf.bouncycastle.crypto.modes.OFBBlockCipher;
import pdf.bouncycastle.crypto.modes.OpenPGPCFBBlockCipher;
import pdf.bouncycastle.crypto.modes.PGPCFBBlockCipher;
import pdf.bouncycastle.crypto.modes.SICBlockCipher;
import pdf.bouncycastle.crypto.paddings.BlockCipherPadding;
import pdf.bouncycastle.crypto.paddings.ISO10126d2Padding;
import pdf.bouncycastle.crypto.paddings.ISO7816d4Padding;
import pdf.bouncycastle.crypto.paddings.PaddedBufferedBlockCipher;
import pdf.bouncycastle.crypto.paddings.TBCPadding;
import pdf.bouncycastle.crypto.paddings.X923Padding;
import pdf.bouncycastle.crypto.paddings.ZeroBytePadding;
import pdf.bouncycastle.crypto.params.AEADParameters;
...
import pdf.bouncycastle.crypto.params.RC5Parameters;
import pdf.bouncycastle.jcajce.PBKDF1Key;
...
import pdf.bouncycastle.jcajce.spec.AEADParameterSpec;
import pdf.bouncycastle.jcajce.spec.GOST28147ParameterSpec;
import pdf.bouncycastle.jcajce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        pdf.bouncycastle.crypto.BlockCipher engine,
        int ivLength)
    {
    ...
    static private interface GenericBlockCipher
    {
        ...
        public pdf.bouncycastle.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(pdf.bouncycastle.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(pdf.bouncycastle.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
