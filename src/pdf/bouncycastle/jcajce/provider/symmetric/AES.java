...
import pdf.bouncycastle.asn1.bc.BCObjectIdentifiers;
...
import pdf.bouncycastle.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import pdf.bouncycastle.jcajce.provider.symmetric.util.BaseSecretKeyFactory;
import pdf.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher;
...
import pdf.bouncycastle.jcajce.provider.symmetric.util.PBESecretKeyFactory;
...
public final class AES
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new pdf.bouncycastle.crypto.macs.Poly1305(new AESEngine()));
        }
    }
