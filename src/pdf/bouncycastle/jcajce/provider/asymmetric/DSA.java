...
import pdf.bouncycastle.jcajce.provider.asymmetric.dsa.DSAUtil;
import pdf.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
...
public class DSA
{
    private static final String PREFIX = "pdf.bouncycastle.jcajce.provider.asymmetric" + ".dsa.";
