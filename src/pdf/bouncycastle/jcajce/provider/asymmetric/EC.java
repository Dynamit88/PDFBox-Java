...
import pdf.bouncycastle.asn1.bsi.BSIObjectIdentifiers;
...
import pdf.bouncycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            if (!Properties.isOverrideSet("pdf.bouncycastle.ec.disable_mqv"))
            {
