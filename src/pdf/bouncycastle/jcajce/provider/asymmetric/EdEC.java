...
import pdf.bouncycastle.jcajce.provider.asymmetric.edec.KeyFactorySpi;
...
public class EdEC
{
    private static final String PREFIX = "pdf.bouncycastle.jcajce.provider.asymmetric" + ".edec.";
