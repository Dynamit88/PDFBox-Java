...
import pdf.bouncycastle.math.field.FiniteField;
import pdf.bouncycastle.math.field.Polynomial;
import pdf.bouncycastle.math.field.PolynomialExtensionField;
...
public class EC5Util
{
    ...
    public static pdf.bouncycastle.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ...
        {
            return new pdf.bouncycastle.jce.spec.ECNamedCurveParameterSpec(
        ...
        {
            return new pdf.bouncycastle.jce.spec.ECParameterSpec(
                curve,
                convertPoint(curve, ecSpec.getGenerator(), withCompression),
                ecSpec.getOrder(),
                BigInteger.valueOf(ecSpec.getCofactor()),
    ...
    public static pdf.bouncycastle.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
    ...
    public static ECPoint convertPoint(pdf.bouncycastle.math.ec.ECPoint point)
    {
