package pdf.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import pdf.bouncycastle.asn1.ua.DSTU4145BinaryField;
import pdf.bouncycastle.asn1.ua.DSTU4145ECBinary;
import pdf.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import pdf.bouncycastle.asn1.ua.DSTU4145Params;
import pdf.bouncycastle.asn1.ua.DSTU4145PointEncoder;
...
import pdf.bouncycastle.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
...
import pdf.bouncycastle.jce.spec.ECNamedCurveSpec;
import pdf.bouncycastle.math.ec.ECCurve;

public class BCDSTU4145PrivateKey
    implements ECPrivateKey, pdf.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCDSTU4145PrivateKey(
        pdf.bouncycastle.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    spec = new pdf.bouncycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
                }
        ...
        {
            pdf.bouncycastle.asn1.sec.ECPrivateKey ec = pdf.bouncycastle.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        PrivateKeyInfo info;
        pdf.bouncycastle.asn1.sec.ECPrivateKey keyStructure;

        if (publicKey != null)
        {
            keyStructure = new pdf.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
        }
        else
        {
            keyStructure = new pdf.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
        }
