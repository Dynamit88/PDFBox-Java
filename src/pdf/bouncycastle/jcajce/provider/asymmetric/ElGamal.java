...
import pdf.bouncycastle.jcajce.provider.asymmetric.elgamal.KeyFactorySpi;
...
{
    private static final String PREFIX = "pdf.bouncycastle.jcajce.provider.asymmetric" + ".elgamal.";
