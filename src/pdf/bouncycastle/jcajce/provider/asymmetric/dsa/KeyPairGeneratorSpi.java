...
import pdf.bouncycastle.crypto.generators.DSAKeyPairGenerator;
import pdf.bouncycastle.crypto.generators.DSAParametersGenerator;
import pdf.bouncycastle.crypto.params.DSAKeyGenerationParameters;
import pdf.bouncycastle.crypto.params.DSAParameterGenerationParameters;
                ...
                synchronized (lock)
                {
                    ...
                    else
                    {
                        ...
                        if (strength == 1024)
                        {
                            ...
                            if (Properties.isOverrideSet("pdf.bouncycastle.dsa.FIPS186-2for1024bits"))
                            {
