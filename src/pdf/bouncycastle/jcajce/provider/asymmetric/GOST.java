...
import pdf.bouncycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "pdf.bouncycastle.jcajce.provider.asymmetric" + ".gost.";
