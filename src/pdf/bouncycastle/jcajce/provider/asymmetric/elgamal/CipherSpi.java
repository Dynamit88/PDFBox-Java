package pdf.bouncycastle.jcajce.provider.asymmetric.elgamal;
...
import pdf.bouncycastle.crypto.encodings.ISO9796d1Encoding;
import pdf.bouncycastle.crypto.encodings.OAEPEncoding;
import pdf.bouncycastle.crypto.encodings.PKCS1Encoding;
import pdf.bouncycastle.crypto.engines.ElGamalEngine;
import pdf.bouncycastle.crypto.params.ParametersWithRandom;
import pdf.bouncycastle.jcajce.provider.asymmetric.util.BaseCipherSpi;
import pdf.bouncycastle.jcajce.provider.util.BadBlockException;
import pdf.bouncycastle.jcajce.provider.util.DigestFactory;
import pdf.bouncycastle.jce.interfaces.ElGamalKey;
