...
import pdf.bouncycastle.jcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "pdf.bouncycastle.jcajce.provider.asymmetric" + ".rsa.";
