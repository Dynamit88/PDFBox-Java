package pdf.bouncycastle.jcajce.provider.drbg;
...
import pdf.bouncycastle.crypto.prng.EntropySource;
import pdf.bouncycastle.crypto.prng.EntropySourceProvider;
import pdf.bouncycastle.crypto.prng.SP800SecureRandom;
import pdf.bouncycastle.crypto.prng.SP800SecureRandomBuilder;
...
public class DRBG
{
    ...
    {
        final String sourceClass = System.getProperty("pdf.bouncycastle.drbg.entropysource");
    ...
    {
        if (System.getProperty("pdf.bouncycastle.drbg.entropysource") != null)
        {
