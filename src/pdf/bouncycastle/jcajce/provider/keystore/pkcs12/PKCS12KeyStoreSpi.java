package pdf.bouncycastle.jcajce.provider.keystore.pkcs12;
...
import pdf.bouncycastle.asn1.BEROutputStream;
import pdf.bouncycastle.asn1.DERBMPString;
...
import pdf.bouncycastle.asn1.pkcs.AuthenticatedSafe;
import pdf.bouncycastle.asn1.pkcs.CertBag;
import pdf.bouncycastle.asn1.pkcs.ContentInfo;
import pdf.bouncycastle.asn1.pkcs.EncryptedData;
import pdf.bouncycastle.asn1.pkcs.MacData;
...
import pdf.bouncycastle.asn1.pkcs.Pfx;
import pdf.bouncycastle.asn1.pkcs.SafeBag;
import pdf.bouncycastle.asn1.util.ASN1Dump;
import pdf.bouncycastle.asn1.x509.AlgorithmIdentifier;
import pdf.bouncycastle.asn1.x509.AuthorityKeyIdentifier;
import pdf.bouncycastle.asn1.x509.DigestInfo;
import pdf.bouncycastle.asn1.x509.Extension;
import pdf.bouncycastle.asn1.x509.SubjectKeyIdentifier;
...
import pdf.bouncycastle.jcajce.PKCS12StoreParameter;
import pdf.bouncycastle.jcajce.spec.GOST28147ParameterSpec;
import pdf.bouncycastle.jcajce.spec.PBKDF2KeySpec;
...
import pdf.bouncycastle.jce.interfaces.BCKeyStore;
import pdf.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier;
import pdf.bouncycastle.jce.provider.BouncyCastleProvider;
import pdf.bouncycastle.jce.provider.JDKPKCS12StoreParameter;
...
{
    static final String PKCS12_MAX_IT_COUNT_PROPERTY = "pdf.bouncycastle.pkcs12.max_it_count";
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            pdf.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = pdf.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            pdf.bouncycastle.asn1.pkcs.PrivateKeyInfo kInfo = pdf.bouncycastle.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            pdf.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new pdf.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
