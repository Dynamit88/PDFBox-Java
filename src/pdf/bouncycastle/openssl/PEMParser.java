...
import pdf.bouncycastle.cert.X509AttributeCertificateHolder;
...
import pdf.bouncycastle.pkcs.PKCS8EncryptedPrivateKeyInfo;
import pdf.bouncycastle.util.encoders.Hex;
import pdf.bouncycastle.util.io.pem.PemHeader;
import pdf.bouncycastle.util.io.pem.PemObject;
import pdf.bouncycastle.util.io.pem.PemObjectParser;
import pdf.bouncycastle.util.io.pem.PemReader;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                pdf.bouncycastle.asn1.sec.ECPrivateKey pKey = pdf.bouncycastle.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                pdf.bouncycastle.asn1.pkcs.RSAPrivateKey keyStruct = pdf.bouncycastle.asn1.pkcs.RSAPrivateKey.getInstance(seq);
