 ...
 */
package pdf.pdfbox.pdfparser;

import static pdf.pdfbox.util.Charsets.ISO_8859_1;
...
public class COSParser extends BaseParser
{
    ...
    public static final String SYSPROP_PARSEMINIMAL = 
            "pdf.pdfbox.pdfparser.nonSequentialPDFParser.parseMinimal";
    ...
    public static final String SYSPROP_EOFLOOKUPRANGE =
            "pdf.pdfbox.pdfparser.nonSequentialPDFParser.eofLookupRange";
