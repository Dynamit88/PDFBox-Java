 ...
 */
package pdf.pdfbox.pdmodel.font.encoding;

import pdf.fontbox.afm.CharMetric;
...
public class Type1Encoding extends Encoding
{
     ...
     */
    public static Type1Encoding fromFontBox(pdf.fontbox.encoding.Encoding encoding)
    {
