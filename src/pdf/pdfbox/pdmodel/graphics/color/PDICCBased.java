 ...
 */
package pdf.pdfbox.pdmodel.graphics.color;
...
import pdf.pdfbox.pdmodel.common.PDRange;
...
public final class PDICCBased extends PDCIEBasedColorSpace
{
     ...
     * {@link PDICCBased#create(pdf.pdfbox.cos.COSArray, pdf.pdfbox.pdmodel.PDResources)}
    ...
    public PDICCBased(COSArray iccArray) throws IOException
    {
        ...
        useOnlyAlternateColorSpace = System
                .getProperty("pdf.pdfbox.rendering.UseAlternateInsteadOfICCColorSpace") != null;
        array = iccArray;
