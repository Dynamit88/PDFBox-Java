...
import pdf.pdfbox.filter.Filter;
import pdf.pdfbox.filter.FilterFactory;
...
import pdf.pdfbox.pdmodel.graphics.color.PDDeviceColorSpace;
...
public final class LosslessFactory
{
     ...
     * {@link PDImageXObject#setColorSpace(pdf.pdfbox.pdmodel.graphics.color.PDColorSpace) PDImageXObject.setColorSpace()}
     *
