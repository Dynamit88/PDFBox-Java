...
import pdf.pdfbox.io.RandomAccess;
import pdf.pdfbox.io.RandomAccessBuffer;
import pdf.pdfbox.io.RandomAccessFile;
...
public final class CCITTFactory
{
     ...
     * files you have, use
     * {@link LosslessFactory#createFromImage(pdf.pdfbox.pdmodel.PDDocument, java.awt.image.BufferedImage)}
     * or {@link CCITTFactory#createFromImage(PDDocument, BufferedImage) }
     * instead.
     *
     * @param document the document to create the image as part of.
