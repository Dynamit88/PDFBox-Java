...
public class LogFactoryImpl extends LogFactory {
    ...
    private static final String LOGGING_IMPL_LOG4J_LOGGER = "pdf.pdfbox.util.log.Log4JLogger";
    /** Jdk14Logger class name */
    private static final String LOGGING_IMPL_JDK14_LOGGER = "pdf.pdfbox.util.log.Jdk14Logger";
    /** Jdk13LumberjackLogger class name */
    private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "pdf.pdfbox.util.log.Jdk13LumberjackLogger";
    /** SimpleLog class name */
    private static final String LOGGING_IMPL_SIMPLE_LOGGER = "pdf.pdfbox.util.log.SimpleLog";
    private static final String PKG_IMPL="pdf.pdfbox.util.log.";
    ...
    public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = 
        "pdf.pdfbox.util.log.Log.allowFlawedContext";
    /**
    ...
    public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = 
        "pdf.pdfbox.util.log.Log.allowFlawedDiscovery";
    /**
    ...
    public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = 
        "pdf.pdfbox.util.log.Log.allowFlawedHierarchy";
    /**
    ...
    private static final String[] classesToDiscover = {
            ...
            "pdf.pdfbox.util.log.Jdk14Logger",
            "pdf.pdfbox.util.log.Jdk13LumberjackLogger",
            "pdf.pdfbox.util.log.SimpleLog"
    };
